...
const EnrichStatusCellRenderer = (props: any) => {
  ...
  const isEnriched = props.data.clay_enriched === true; // We'll assume we pass this down eventually if needed
